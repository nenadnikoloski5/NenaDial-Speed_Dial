...
<div >
                                ...
                                <input  class="input100" id="username" type="text"  name="username" value="{{ old('username') }}" required autofocus>
					...
					<div class="wrap-input100 validate-input">
<div >
                                <input class="input100" id="email" type="text"  name="email" value="{{ old('email') }}" required>
